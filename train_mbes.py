...
## Dataset and loader
parser.add_argument('--dataset_root', type=str, default='./data/mbes-data')
...
## Model architecture
parser.add_argument('--supervised', type=eval, default=False, choices=[True, False])
...
parser.add_argument('--max_iters', type=int, default=100000)#1*MILLION)
...
# TODO: Add proper validation dataset
