...
parser.add_argument('--ckpt', type=str, default='./logs/DPUNet_2024_03_13__11_42_06/ckpt_0.000124_14000.pt')
parser.add_argument('--input_root', type=str, default='./data/mbes-data')
parser.add_argument('--output_root', type=str, default='./logs/DPUNet_2024_03_13__11_42_06/results')
parser.add_argument('--dataset', type=str, default='MBES')
